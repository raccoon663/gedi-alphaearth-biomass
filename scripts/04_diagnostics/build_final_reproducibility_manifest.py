...
def main() -> None:
    ...
    main_artifacts = [
        ...
        "outputs/tables/main_results/final_project_summary.csv",
        "outputs/tables/diagnostics/source_model_comparison.csv",
        "outputs/tables/main_results/representation_transfer_summary.csv",
        "outputs/tables/main_results/kaihua_fewshot_summary.csv",
        "outputs/tables/main_results/kaihua_fewshot_label_efficiency.csv",
        "outputs/tables/main_results/kaihua_label_thresholds.csv",
        "figures/final_workflow.png",
        "figures/source_representation_comparison.png",
        "figures/zero_shot_transfer.png",
        "figures/kaihua_label_efficiency.png",
